...
export default {
  ...
  mounted() {
    // this.countryList = this.countryList.slice(1,2)
    // console.log("ddddd",this.countryList)
    // console.log("ddddd",this.addVal)
  ...
  methods: {
        ...
        .then(res => {
          ...
          for (let i = 0; i < res.length; i++) {
            ...
            // console.log(111111111,o)
                if(this.$store.state.platform == 11){
                  if(o.id == 279|| o.id == 280){
                    // console.log(111111111,o)
                    _this.countryList.push(o)
                  }
                }else if(this.$store.state.platform == 21){
                  if(o.id == 7){
                    _this.countryList.push(o)
                  }
                }else if(this.$store.state.platform == 31){
                  if(!(o.id  == 7 || o.id  == 278 || o.id  == 279 || o.id  == 280)){
                    _this.countryList.push(o)
                  }
                }else if(this.$store.state.platform == 41){
                  if(o.id  == 278){
          ...
          if(this.countryId){
            for(var i=0; i<_this.countryList.length; i++){
              ...
              // if(!this.isLogin){
              //   if(this.$store.state.platform == 11){
              //     if(_this.countryList[i].id == 279|| _this.countryList[i].id == 280){
              //       console.log(111111111,_this.countryList[i])
              //       _this.countryList.push(_this.countryList[i])
              //     }
              //   }else if(this.$store.state.platform == 21){
              //     if(_this.countryList[i].id == 7){
              //       _this.countryList.push(_this.countryList[i])
              //     }
              //   }else if(this.$store.state.platform == 31){
              //     if(!(_this.countryList[i].id == 7 || _this.countryList[i].id == 278 || _this.countryList[i].id == 279 || _this.countryList[i].id == 280)){
              //       _this.countryList.push(_this.countryList[i])
              //     }
              //   }else if(this.$store.state.platform == 41){
              //     if(_this.countryList[i].id == 278){
              //       _this.countryList.push(_this.countryList[i])
              //     }
              //   }
              // }
    ...
    showCountry() {
      // console.log(111111,this.countryList)
    ...
    check(val) {
      // console.log("this.area",this.userTelCode)
      if(!this.isLogin){
