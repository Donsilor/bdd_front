    ...
    <div class="uploadContent">
        ...
        <div class="uploadMsg">
            <div class="Amount">
                ...
                <span class="price" v-if="this.$store.state.platform == 41">
                  <span class="coin">{{ formatCoin(coin) }}</span> 
                  <span class="price">{{ formatAmount(price||ultimatelyPay) }}</span>
                  <!-- <span class="coin-hkd">({{ coinHKD }}</span> 
                  <span class="price-hkd">{{ formatMoney(priceHKD) }})</span> -->
                </span>
                <span v-else><span class="coin">{{ formatCoin(coin) }}</span> <span class="price">{{ formatMoney(price||ultimatelyPay) }}</span></span>
            </div>

            <div class="prompt">{{lang.Note2}}</div>
            ...
            <div class="uploadImg">
                ...
                <div class="upload">
                    <div class="up">
                        ...
                        <span class="up-text">{{lang.pleaseSelectAccount}}</span>
                    </el-upload>
            ...
            <div class="transactionNum">
                ...
                <input class="num-input" type="text" v-model="number" :placeholder="lang.PayTransactionNumber">
            </div>
...
export default {
    ...
    props: ['ultimatelyPay','orderId','price','priceHKD','transferOrderId'], 
    mounted(){
        this.getAccount()
    },
    methods:{
