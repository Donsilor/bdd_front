<template>
  <div class="diamond-component">
    <div class="swiper-box">
      ...
      <swiper1 v-show="!is360" :auto="true" :duration="5000">
    ...
    <div
      v-if="canAddCart && inSale"
      class="btn-common btn-pink"
      @click="goCustomMade(`ring`)"
    >
      {{ lang.addToRingTuo }}
    </div>
    <!--    <div-->
    ...
    <div v-show="addWay" class="addWayMask">
      <div class="addWayBoard">
        ...
        <div class="clickLineBox">
          <div class="clickLine" @click="goCustomMade(`ring`)">
            <i class="iconfont iconstar-jt"></i>
            <span>{{ lang.addToRing }}</span>
          </div>
          <!--          <div class="clickLine" @click="goCustomMade(`necklace`)">-->
          <!--            <i class="iconfont icondiamond-pendant"></i>-->
          <!--            <span>{{ lang.addToNecklace }}</span>-->
          <!--          </div>-->
          <!--          <div class="clickLine" @click="goCustomMade(`bracelet`)">-->
    ...
    .details-4c-box {
      ...
      .box-4c-carat {
        ...
        .carat-line-and-arrow {
          width: 280px;
          height: 11px;
          border-bottom: 1px solid @mcPink;
          display: flex;
          align-items: center;
          justify-content: space-between;
          position: relative;
