                ...
                <div @click="godetails(item, index)">
                  ...
                  <div class="right" v-for="(ring, _index) in item.sku" :key="_index">
                    ...
                    <p class="p">
                      ...
                      <!-- <span class="edit" @click.stop="showEdit(item, index, 'double', _index)"></span> -->
                    </p>
                ...
                <div @click="godetails(item, index)">
                  ...
                  <div class="right">
                    ...
                    <p class="p">
                      ...
                      <span class="edit" @click.stop="showEdit(item, index, 'madeUpB')"></span>
                    </p>
                    ...
                    <div v-if="item.groupType !== 0 && index !== list.length - 1">
                      ...
                      <!-- <span class="edit" @click.stop="showEdit(item, index, 'madeUpA')"></span> -->
                      </p>
      ...
      <div class="edit-box">
        <div class="edit-info">
          ...
          <div v-if="type == 'single'">
            <!-- 主石大小 -->
            <div v-if="carats.length" class="attr-list carats">
            ...
            <!-- 成色 -->
            <div v-if="materials.length" class="attr-list materials">
          ...
          <div v-if="type == 'doubleA'">
            <!-- 主石大小 -->
            <div v-if="caratsA.length" class="attr-list carats">
              <div class="attr-text">{{ caratsText }}</div>
              <div class="attr-box">
            ...
            <!-- 成色 -->
            <div v-if="materialsA.length" class="attr-list materials">
              <div class="attr-text">{{ materialsText }}</div>
              <div class="attr-box">
          ...
          <div v-if="type == 'doubleB'">
            <!-- 主石大小 -->
            <div v-if="caratsB.length" class="attr-list carats">
              <div class="attr-text">{{ caratsText }}</div>
              <div class="attr-box">
            ...
            <!-- 成色 -->
            <div v-if="materialsB.length" class="attr-list materials">
              <div class="attr-text">{{ materialsText }}</div>
              <div class="attr-box">
...
export default {
  ...
  methods: {
    ...
    godetails(item, index) {
      // console.log("itemdetail",typeof  item.simpleGoodsEntity.categoryId)
      // 去定制详情
      if (item.groupType === 2) {
      ...
      // 去单品详情
        ...
        if (parseInt(item.simpleGoodsEntity.categoryId) === 15) {
          // 是个钻石💎
          this.$router.push({
    ...
    showEdit(attr, i, type, typeB=null) {
      ...
      if(this.type == 'madeUpB'){
        this.cartEditIdB = this.list[i+1].id
      }
    ...
    getMakeUpInfoB() {
      ...
      this.goodsId = this.list[this.selectIndex+1].goodsId;
    ...
    getCategoryId() {
      ...
      let lenA = this.productDataA.details.length,
          cartsAId = this.caratsA.length ? this.caratsA[this.doubleSelectedA.caratIndex].id : null,
          materialsAId = this.materialsA.length ? this.materialsA[this.doubleSelectedA.materialIndex].id : null,
          sizesAId = this.sizesA.length ? this.sizesA[this.doubleSelectedA.sizeIndex].id : null;

      for(let o=0; o<lenA; o++){
        if(cartsAId == this.productDataA.details[o].carat &&
          materialsAId == this.productDataA.details[o].material &&
          sizesAId == this.productDataA.details[o].size)
        {
      ...
      let lenB = this.productDataB.details.length,
          cartsBId = this.caratsB.length ? this.caratsB[this.doubleSelectedB.caratIndex].id : null,
          materialsBId = this.materialsB.length ? this.materialsB[this.doubleSelectedB.materialIndex].id : null,
          sizesBId = this.sizesB.length ? this.sizesB[this.doubleSelectedB.sizeIndex].id : null;

      for(let p=0; p<lenB; p++){
        if(cartsBId == this.productDataB.details[p].carat &&
          materialsBId == this.productDataB.details[p].material &&
          sizesBId == this.productDataB.details[p].size)
        {
    ...
    confirmAttr() {
      ...
      if(goodsIndex){
        for(var c=0; c<goodsIndex; c++){
          if(this.list[c].groupType == 2){
            goodsIndex -= 0.5
          }
        }
      }
      ...
      _this.$store
        .dispatch('editCart', [goodInfo, parseInt(goodsIndex)])
        .then(data => {
