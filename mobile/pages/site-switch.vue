  ...
  <div>
    ...
    <div class="page-content">
      <div>
        ...
        <div v-else-if="this.$store.state.platform == 21" class="select-line-box">
...
export default {
  ...
  methods: {
    ...
    changePage(lang,coin) {
      ...
      let host_rul = window.location.host  //当前域名
      let params = window.location.pathname //url参数
      let search = window.location.search
      // console.log(55555,host_rul,params,this.langs)

      let platform = this.$store.state.platform

      if(platform == 21 && this.langs == 'zh_TW'){
        if (!(/bdd.bddco.cn/).test(host_rul)) {
            window.location.href="https://wap.bddco.com"+ params + search;
        } else{
            window.location.href="https://wap-bdd.bddco.cn"+ params + search;
        }
          
      }
      // else if(platform == 21 && this.langs == 'en_US'){  https://wap-cn-bdd.bddco.cn/
      //   if ((/bddco.cn/).test(host_rul)) {
      //       window.location.href="https://wap-us.bddco.com"+ params;
      //   } else{
      //       window.location.href="https://wap-us-bdd.bddco.cn"+ params;
      //   }
      // }
      
      // this.$store.commit('setLanguage', val)
      if(platform == 11 || platform == 31||platform == 41||(platform == 21&&this.langs == 'zh_CN')){
        setTimeout(() => {
