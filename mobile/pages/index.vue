<template>
  <div class="page">
    ...
    <div v-if="platform == 11 || platform == 21 || platform == 41">
      ...
      <section v-if="platform == 21">
        <div class="video-box">
          <video controls="controls" src="https://cloud.video.taobao.com//play/u/2200750399716/p/1/e/6/t/1/293471851253.mp4" poster="index/video-bg.jpg">
          <!-- <video controls="controls" src="/video/bdd-video-2.mp4" autoplay="autoplay" muted > -->
            <!-- <source type="video/mp4" /> -->
          </video>
        </div>
      </section>

      <section v-if="platform == 11">
        <div class="video-box">
          <video controls="controls" src="https://cloud.video.taobao.com//play/u/2200750399716/p/1/e/6/t/1/292596232392.mp4" poster="index/video-bg2.jpg"></video>
        </div>
      </section>

      <section v-if="platform == 41">
        <div class="video-box">
          <video controls="controls" src="https://cloud.video.taobao.com//play/u/2200750399716/p/1/e/6/t/1/292913137799.mp4" poster="index/video-bg2.jpg"></video>
        </div>
      </section>
...
.us-page{
  ...
  .host-bar{
      ...
      .left-button{
        width: 36px;
        height: 36px;
        background: #ff6900 url('/index-us/icon-left.png') center;
      ...
      .right-button{
        width: 36px;
        height: 36px;
        background: #ff6900 url('/index-us/icon-right.png') center;
        background-size: 80% 80%;
        border-radius: 50%;
        position: absolute;
        top: 50%;
