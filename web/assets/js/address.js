        ...
        .then(res => {
            ...
            if(this.country.areaId){
              for(var i=0; i<res.data.length; i++){
                ...
                if(!this.isLogin){
                  if(this.$store.state.platform == '20'){
                    if(res.data[i].areaId == 7){
                      this.countryList.push(res.data[i]) 
                    }
                  }else if(this.$store.state.platform == '10'){
                    if(res.data[i].areaId == 279|| res.data[i].areaId == 280){
                      this.countryList.push(res.data[i]) 
                    }
                  }else if(this.$store.state.platform == '30'){
                    if(!(res.data[i].areaId == 7 || res.data[i].areaId == 278 || res.data[i].areaId == 279 || res.data[i].areaId == 280)){
                      this.countryList.push(res.data[i]) 
                    } 
                  }else if(this.$store.state.platform == '40'){
                    if(res.data[i].areaId == 278){
                      this.countryList.push(res.data[i]) 
                    }
                  }
                } else {
