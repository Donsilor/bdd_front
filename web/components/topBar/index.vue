        ...
        <div class="row-flex justify-between shortcut-content">
          ...
          <!--  <nuxt-link
            ...
            <div class="item language">
              ...
              <!-- 大陆语言选择 -->
              <el-dropdown
                v-else-if="this.$store.state.platform === 20"
                type="primary"
        ...
        <div class="nav-box">
          <div class="row-flex nav-content">
            <div class="row-flex align-item-center left-item">
              <div class="logo">
                <nuxt-link to="/">
                  <img src="/components/topBar/logo-2.0.png" />
                </nuxt-link>
              </div>
            </div>
            <div class="row-flex align-item-center justify-end right-item">
...
export default {
  ...
  methods: {
    ...
    setLanguage(lang) {
      ...
      if(platform == 10 || platform == 30||platform == 40||(platform == 20 && lang == 'zh_CN')){
        window.location.reload()
      }
      let aa ='https://www.bddco.cn/'
      if(platform == 20 && lang == 'zh_TW'){
        if (!(/bdd.bddco.cn/).test(host_rul)) {
          window.location.href="https://www.bddco.com"+ params + search;
        } else{
          window.location.href="https://www-bdd.bddco.cn"+ params + search;
        } 
      }
      // else if(platform == 20 && lang == 'en_US'){
      //   if ((/bddco.cn/).test(host_rul)) {
      //       window.location.href="https://us.bddco.com"+ params;
      //   } else if((/bddia\.com/).test(host_rul)){
      //       window.location.href="https://us-bdd.bddco.cn"+ params;
      //   }
      // }
    },
    logout() {
