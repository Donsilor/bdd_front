  ...
  <div :class="['footer-bar']">
    ...
    <footer class="copy-right">
      <div class="copy-right-content">
        ...
        <div v-if="this.$store.state.platform === 20">{{ $t(`${lang}.copyrightRight1`) }}<a target="_blank" href="https://beian.miit.gov.cn">20035106</a>{{ $t(`${lang}.copyrightRight2`) }}</div>
      ...
      menusCn: [
        ...
        {},
        {
          ...
          children: [
            {
              icon: 'iconicon-xiaoxi',
              name: this.$t(`${lang}.contactTimeCn`),
              to: {
                path: '/contact-us'
              }
            },
            ...
            {
              icon: 'iconyouxiang',
              name: this.$t(`${lang}.contactEmailCn`),
              to: {
                path: '/contact-us'
              }
            }
