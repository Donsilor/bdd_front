          ...
          <div class="single-step-right-side">
            <div class="single-step-right-side-icon" :class="[step === 2 ? 'active' : '']">
              <i
                ...
                class="iconfont iconstar-jt"
              ></i>
              <i v-else class="iconfont iconicon-zuanshi"></i>
            </div>
            <div
    ...
    stepCheck(step) {
      ...
      if (step === 1) {
        ...
        return `/build-your-own-ring/${
          copy.steps[0].ct === 1 ? 'diamonds' : 'settings'
        }?steps=${urlStep}&selectGoodsId=${copy.steps[0].goodsId}&step=1`
      } else {
        var type = copy.steps[1].ct;
        ...
        const urlStep = this.$helpers.base64Encode(strStep)
        return `/build-your-own-ring/${
          type === 1 ? 'diamonds' : 'settings'
        }?steps=${urlStep}&selectGoodsId=${copy.steps[1].goodsId}&step=2`
      }
    }
  }
}
