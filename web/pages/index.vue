<template>
  <div class="page">
        ...
        <el-carousel trigger="click" :autoplay="true" :height="bannerHeight + 'px'" class="banner-box">
          <!-- <el-carousel-item class="banner-item">
            <video controls="controls" autoplay="autoplay" muted>
              <source src="https://vkceyugu.cdn.bspapp.com/VKCEYUGU-imgbed/4a063604-722e-4457-b1a4-d638f7da296f.mp4" type="video/mp4" />
            </video>  
          </el-carousel-item> -->
    ...
    <section v-if="platform == 20">
      <div class="video-box">
        <video controls="controls" autoplay="autoplay" muted>
          <source src="https://cloud.video.taobao.com//play/u/2200750399716/p/1/e/6/t/1/293471851253.mp4" type="video/mp4" />
        </video>
      </div>
    </section>

    <section v-if="platform == 10">
      <div class="video-box">
        <video controls="controls" autoplay="autoplay" muted>
          <source src="https://cloud.video.taobao.com//play/u/2200750399716/p/1/e/6/t/1/292596232392.mp4" type="video/mp4" />
        </video>
      </div>
    </section>

    <section v-if="platform == 40">
      <div class="video-box">
        <video controls="controls" autoplay="autoplay" muted>
          <source src="https://cloud.video.taobao.com//play/u/2200750399716/p/1/e/6/t/1/292913137799.mp4" type="video/mp4" />
        </video>
      </div>
    </section>
