  ...
  <div class="cart">
    <div class="cart-container">
      ...
      <div class="cart-goods">
        <div v-for="(g, index) in good" :key="index" :class="[{'active': isActive == index}, {'action': activeIndex == index}]" ref="goodsDiv">
          <div v-if="g.groupType === null && Number(g.data[0].goodsType) !== 19" class="finished" @mousemove="isActive = index"> 
            <div
          ...
          <div v-if="g.data[0].goodsType == '19'" class="couple">
            ...
            <div v-else class="cart-radio"></div>
            <double :g="g" :index="index" :good="good" @reloadList="getList"  @bottomData='refreshData' @getIndex="getIndex" @closeAttr="closeAttr"></double>
          </div>
          <div v-if="g.groupType === 2" class="customization">
            ...
            <div v-else class="cart-radio"></div>
            <madeUp :g="g" :index="index" :good="good" :word="$t(`${lang}.customMade`)" @reloadList="getList" @bottomData='refreshData' @getIndex="getIndex" @closeAttr="closeAttr"></madeUp>
          </div>
        </div>
      </div>
