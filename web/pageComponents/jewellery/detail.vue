<template>
  <div class="page-content detail-page">
    ...
    <section class="detail">
      ...
      <div class="right-detail">
        ...
        <div v-if="productInfo.carats.length == ''">
          <div class="sku" v-if="productInfo.materials.length > 0 ||colorDetail.length > 0 || productInfo.sizes.length > 0">
    ...
    <!--    推荐商品-->
    <section class="list-content recommend" v-if="recommends.length>0">
